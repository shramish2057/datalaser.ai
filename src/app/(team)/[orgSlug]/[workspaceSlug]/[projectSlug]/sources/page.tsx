...
export default function TeamSourcesPage() {
  ...
  if (sources.length === 0) return (
    <div className="flex items-center justify-center h-full p-8"><div className="text-center max-w-sm">
      <div className="w-16 h-16 rounded-full bg-mb-bg-medium flex items-center justify-center mx-auto mb-4"><Database size={28} className="text-mb-text-light" /></div>
      <h2 className="text-mb-xl font-black text-mb-text-dark mb-2">No data sources yet</h2>
      <p className="text-mb-text-medium text-mb-base mb-6">Connect a database, upload a CSV, or link a SaaS tool to get started.</p>
      <button className="mb-btn-primary px-6 py-2" onClick={() => router.push(`${base}/sources/new`)}><Plus size={14} /> Add your first data source</button>
    </div></div>
  )
