...
export default function TeamProjectSettingsPage() {
  ...
  return (
    <div className="max-w-2xl mx-auto px-6 py-8">
      ...
      <div className="mb-6"><label className="mb-label">{t("common.projectName")}</label><input className="mb-input" value={name} onChange={e => setName(e.target.value)} /></div>
      <div className="mb-6"><label className="mb-label">{t("common.description")}</label><textarea className="mb-input min-h-[80px] resize-none" placeholder={t("settings.projectDescription")} value={description} onChange={e => setDescription(e.target.value)} /></div>
        ...
        <DialogContent className="bg-mb-bg border border-mb-border rounded-mb-lg shadow-mb-lg p-0 max-w-md">
          ...
          <div className="p-6 pt-4">
            ...
            <div className="flex justify-end gap-3">
              <button onClick={() => setDeleteOpen(false)} className="mb-btn-secondary">{t("common.cancel")}</button>
