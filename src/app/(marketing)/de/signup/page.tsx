  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-6 py-12"><div className="w-full max-w-sm">
      ...
      <div className="dl-card p-6">
        ...
        <div className="mb-4">
          <label className="dl-label">{t('onboarding.fullName')}</label>
          <input className="dl-input" type="text" value={name}
      ...
      <p className="text-center text-dl-sm text-dl-text-medium mt-4">
        {t('auth.hasAccount')}{' '}
        <Link href="/de/login" className="text-dl-brand font-bold hover:text-dl-brand-dark">
          {t('auth.signIn')}
        </Link>
      </p>
    </div></div>
