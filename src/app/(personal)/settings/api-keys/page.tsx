  ...
  return (
    <SettingsShell>
      ...
      <div className="dl-card p-8 text-center">
        <div className="w-12 h-12 rounded-full bg-dl-bg-medium flex items-center justify-center mx-auto mb-3">
          <Key size={20} className="text-dl-text-light" />
        </div>
        <p className="text-dl-text-dark text-dl-sm font-bold">API access coming soon</p>
        <p className="text-dl-text-medium text-dl-xs mt-1 max-w-sm mx-auto">
