...
export function OrgSettingsShell({ orgSlug, children }: { orgSlug: string; children: React.ReactNode }) {
  ...
  const nav = [
    ...
    { label: t('access.title'), href: `${base}/access` },
    { label: t('settings.billing'), href: `${base}/billing` },
    { label: t('settings.apiKeys'), href: `${base}/api-keys` },
  ]
    ...
    <div className="flex h-full font-sans">
      <nav className="w-[280px] flex-shrink-0 border-r border-dl-border bg-dl-bg flex flex-col">
        ...
        <div className="px-4 py-4 flex-1">
          <p className="dl-section-header mb-3">{t('onboarding.orgName')}</p>
